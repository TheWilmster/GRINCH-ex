function scr_player_bombpep()
{
	...
	if (input_buffer_jump < 8 && place_meeting(x, (y + 1), obj_collisionparent) && hsp != 0)
	{
	...
	if (movespeed < 4)
	    ...
	    image_speed = 0.6
	if (hsp != 0 && (floor(image_index) == 0 || floor(image_index) == 2) && steppy == 0 && place_meeting(x, (y + 1), obj_collisionparent))
	{
