if (vsp < 30)
    vsp += grav
if ((!((obj_player.state == 35 || obj_player.state == 30 || obj_player.state == 32 || obj_player.state == 31 || obj_player.state == 36 || obj_player.state == 37 || obj_player.state == 38 || obj_player.state == 39 || obj_player.state == 40))) && grabbed == 1)
{
    instance_destroy()
