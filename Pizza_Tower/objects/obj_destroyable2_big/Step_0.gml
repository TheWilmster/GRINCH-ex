...
if (place_meeting(x, (y - 1), obj_player) && obj_player.state == 63)
{
    instance_destroy()
...
if ((place_meeting((x + 1), y, obj_player) || place_meeting((x - 1), y, obj_player)) && (obj_player.state == 59 || obj_player.state == 79 || obj_player.state == 26))
{
...
if (place_meeting(x, (y - 1), obj_player) && obj_player.vsp > 0 && (obj_player.state == 63 || obj_player.state == 32 || obj_player.state == 13))
    instance_destroy()
if ((place_meeting(x, (y + 1), obj_player) || (place_meeting((x - 1), y, obj_player) && obj_player.xscale == 1) || (place_meeting((x + 1), y, obj_player) && obj_player.xscale == -1)) && obj_player.state == 52)
    instance_destroy()
