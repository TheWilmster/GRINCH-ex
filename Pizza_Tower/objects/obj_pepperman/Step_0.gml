...
if (obj_player.state == 35 || obj_player.state == 32 || (!(place_meeting(x, (y + 1), obj_collisionparent))))
{
    stunned = 1
    movespeed = 0
    charging = 0
...
if (thrown == 0 && (obj_player.state == 17 || obj_player.state == 35 || obj_player.state == 30 || obj_player.state == 36 || obj_player.state == 38 || obj_player.state == 32 || obj_player.state == 39 || obj_player.state == 37))
{
    charging = 0
    chargingdown = 0
    movespeed = 0
