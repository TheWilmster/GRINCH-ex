if (stun == 0 && obj_player.y >= y && obj_player.attacking == 0 && obj_player.state != 46 && obj_player.state != 62 && obj_player.state != 61 && (!(vsp < 0)) && obj_player.instakillmove == 0)
{
...
if (obj_player.y < y && obj_player.state != 62 && obj_player.attacking == 0 && obj_player.state != 61 && (!(vsp < 0)) && obj_player.instakillmove == 0)
{
    if (x != other.x)
    {
        hsp = (sign((x - obj_player.x)) * 3)
...
if (stun == 0 && obj_player.attacking == 1 && obj_player.state != 62 && obj_player.state != 46 && (!(vsp < 0)) && obj_player.instakillmove == 0)
{
    obj_player.image_index = 0
    obj_player.state = 46
    if (x != other.x)
...
if (obj_player.attacking == 1 && (!((obj_player.state == 59 && obj_player.y < y && stun == 1))) && stun == 1 && (!(obj_player.state == 46)))
{
    if (obj_player.y < y && obj_player.instakillmove == 0 && stun == 0)
        obj_player.vsp = -5.5
    if (obj_player.machpunchAnim == 0 && obj_player.state == 59)
    {
...
with (obj_player)
{
    if (other.stun == 1 && other.vsp >= 0 && state != 62 && state != 46 && state != 35)
    {
        instance_destroy(other.id)
        if (y < other.y && state == 59)
        {
            with (instance_create(x, y, obj_pepgoblindead))
                grabbed = 1
            vsp = -4
