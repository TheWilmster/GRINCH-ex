...
if (obj_player.state == 11 && obj_player.sprite_index != spr_player_suplexmash1 && obj_player.sprite_index != spr_player_suplexmash2 && obj_player.sprite_index != spr_player_suplexmash3 && obj_player.sprite_index != spr_player_suplexmash4)
{
